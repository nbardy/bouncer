...
{{
var G__27785 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27785;
continue;
}
} else
...
{var pred__27789 = cljs.core._EQ_;var expr__27790 = limit;if(cljs.core.truth_(pred__27789.call(null,1,expr__27790)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__27789.call(null,2,expr__27790)))
...
var G__27792 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27793 = (limit__$1 - 1);
var G__27794 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27792;
limit__$1 = G__27793;
parts = G__27794;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___27796 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___27796))
{var replacement_27797 = temp__4090__auto___27796;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_27797)));
} else
{buffer.append(ch);
}
{
var G__27798 = (index + 1);
index = G__27798;
continue;
}
}
