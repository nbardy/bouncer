...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_27608 = 0;while(true){
var m_27609 = cljs.core.async.impl.dispatch.tasks.pop();if((m_27609 == null))
{} else
{m_27609.call(null);
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__11124__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__11124__auto__)
